...
function guardar(){
    ...
    if(id>0){
        ...
        $.ajax({
            ...
            dataType: 'text',
            type: 'post',
            data: {'id': id, 'jsma': mar, 'jsi': interfaz, 'jsm': modelo, 'jsp':precio, 'jsim':imgp ,'jsi2':img2,'jsi3':img3,'jsi4':img4,'jsi5':img5  },
            success: function( data ){
                console.log(data);
                if(data==1){
...
function editar(id){
    $.ajax({
        ...
        success: function( data ){
            ...
            $("#txtinterfaz").val(datos.interfaz);
